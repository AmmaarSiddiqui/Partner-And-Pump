...
Make sure to email mas954@uw.edu for environment variables. To use them, create an .env file in src and follow the src/.env.example formatting using the given environment variables.
